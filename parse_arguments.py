...
def parse_arguments(argv):
    ...
    p.add_argument('--mode', type=str,
                    help="Which CBRAIN tool is being used?")
    ...
    # Import Modules
    p.add_argument('--im_dcm2nii', type=str, default="1",
                   help="Boolean: Use the DICOM to NIfTI import module")
    p.add_argument('--im_nii2bids', type=str, default="1",
                   help="Boolean: Use the NIfTI to BIDS import module")
    p.add_argument('--im_deface', type=str, default = "1",
                   help="Boolean: Use the defacing import module")
    p.add_argument('--im_bids2legacy', type=str, default="1",
                   help="Boolean: Use the BIDS to xASL Legacy import module")

    # Process Modules
    p.add_argument('--pm_structural', type=str, default="1",
                   help="Boolean: Use the structural process module")
    p.add_argument('--pm_asl', type=str, default="1",
                   help="Boolean: Use the ASL process module")
    p.add_argument('--pm_population', type=str, default="1",
    ...
    p.add_argument('--x__modules__asl__M0_conventionalProcessing', type=int, default=0,
    ...
    p.add_argument('--x__modules__asl__M0_GMScaleFactor', type=int, default=1,
    ...
    p.add_argument('--x__Q__SaveCBF4D', type=int, default=0,
                   help="Boolean, true to also save 4D CBF timeseries, if ASL4D had timeseries.\nDEFAULT=false")

    # ASL Processing Parameters
    p.add_argument('--x__modules__asl__motionCorrection', type=int, default=1,
    ...
    p.add_argument('--x__modules__asl__bRegisterM02ASL', type=int, default=0,
    ...
    p.add_argument('--x__modules__asl__bUseMNIasDummyStructural', type=int, default=0,
    ...
    p.add_argument('--x__modules__asl__bPVCNativeSpace', type=int, default=0,
    ...
    p.add_argument('--x__modules__asl__bPVCGaussianMM', type=int, default=0,
    ...
    p.add_argument('--x__modules__bRunLongReg', type=int, default=0,
                   help="Run longitudinal registration.\nDEFAULT = 0")
    p.add_argument('--x__modules__bRunDARTEL', type=int, default=0,
                   help="Run between-subject registration/create templates.\nDEFAULT = 0")
    p.add_argument('--x__modules__structural__bSegmentSPM12', type=int, default=0,
                   help="Boolean to specify if SPM12 segmentation is run instead of CAT12. Options: 1 = run SPM12, 0 = run CAT12.\nDEFAULT = 0")
    p.add_argument('--x__modules__structural__bHammersCAT12', type=int, default=0,
                   help="Boolean specifying if CAT12 should provide Hammers volumetric ROI results.\nDEFAULT = 0")
    p.add_argument('--x__modules__structural__bFixResolution', type=int, default=0,
                   help="Resample to a resolution that CAT12 accepts.\nDEFAULT = 0")

    # General processing parameters
    p.add_argument('--x__settings__Quality', type=int, default=1,
    ...
    p.add_argument('--x__settings__DELETETEMP', type=int, default=1,
    ...
    p.add_argument('--x__settings__SkipIfNoFlair', type=int, default=0,
    ...
    p.add_argument('--x__settings__SkipIfNoASL', type=int, default=0,
    ...
    p.add_argument('--x__settings__SkipIfNoM0', type=int, default=0,
    ...
    p.add_argument('--x__settings__bLesionFilling', type=int, default=1,
                   help="Boolean for lesion filling in structural module (submodule 5).\nDEFAULT = true")
    p.add_argument('--x__settings__bAutoACPC', type=int, default=1,
